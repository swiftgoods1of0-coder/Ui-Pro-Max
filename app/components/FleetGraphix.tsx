...
export default function FleetGraphix() {
  return (
    <section
      id="fleet-graphix"
      className="py-24 relative overflow-hidden bg-charcoal-800"
      aria-label="Fleet Graphix vehicle wraps and branding"
    >
      {/* Background accents */}
      <div className="absolute inset-0 bg-gradient-to-br from-charcoal-900 via-charcoal-900 to-charcoal-950" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              ...
              >
                <img
                  src="/fleet-graphix.jpg"
                  alt="Fleet Graphix technician applying vinyl wrap to a vehicle"
