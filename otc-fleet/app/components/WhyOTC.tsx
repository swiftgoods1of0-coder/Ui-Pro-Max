...
export default function WhyOTC() {
  return (
    <section id="why-otc" className="py-24 bg-navy-800" aria-label="Why choose OTC">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            >
              ...
              {/* Orange top accent */}
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-orange-500 to-orange-600-dark" />
            </div>
