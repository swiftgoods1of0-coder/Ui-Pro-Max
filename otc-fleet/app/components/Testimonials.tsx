              ...
              <div className="relative bg-navy-800 border border-white/10 rounded-lg p-8 h-full flex flex-col hover:border-[#f97316]/40 transition-colors duration-300">
                ...
                <div className="flex gap-1 mb-6">
                  {Array.from({ length: t.rating }).map((_, s) => (
                    <Star key={s} className="w-5 h-5 fill-[#f97316] text-[#f97316]" />
                  ))}
                </div>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#f97316] text-white font-bold rounded hover:bg-[#e6be00] transition-colors duration-200 text-sm tracking-wide"
              >
