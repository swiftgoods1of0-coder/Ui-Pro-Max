...
export default function FleetPrograms() {
  ...
  return (
    <section id="fleet-programs" className="py-24 bg-charcoal-900 relative overflow-hidden" aria-label="Fleet programs">
      {/* Background accents */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-brand/5 blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[300px] h-[300px] rounded-full bg-charcoal-600/20 blur-[80px] pointer-events-none" />
