...
export default function FleetPrograms() {
  ...
  return (
    <section id="fleet-programs" className="py-24 bg-navy-800 relative overflow-hidden" aria-label="Fleet programs">
      {/* Background accents */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-orange-500/5 blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[300px] h-[300px] rounded-full bg-navy-800/20 blur-[80px] pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:sticky lg:top-24">
            ...
            >
              {/* Card header */}
              <div className="bg-gradient-to-r from-orange-500 to-orange-600-dark px-6 py-5">
