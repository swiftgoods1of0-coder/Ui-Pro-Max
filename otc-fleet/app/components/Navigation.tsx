    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled
            ? 'backdrop-blur-md bg-navy-900/95 border-b border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.5)]'
            : 'backdrop-blur-md bg-navy-900/80 border-b border-white/5'
        }`}
      >
      ...
      <AnimatePresence>
        {isMobileOpen && (
          <motion.div
            ...
            className="fixed top-0 right-0 bottom-0 z-50 w-80 max-w-[90vw] bg-navy-900 border-l border-white/10 lg:hidden flex flex-col"
          >
            {/* Mobile Menu Header */}
            ...
            <div className="px-4 py-6 border-t border-white/10 space-y-3">
              <a
                href="tel:7172083600"
                className="flex items-center gap-3 px-4 py-3 rounded-lg bg-navy-800 hover:bg-navy-700 transition-colors text-white"
              >
