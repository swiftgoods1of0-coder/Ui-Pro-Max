    ...
    <>
      ...
      <AnimatePresence>
        {isMobileOpen && (
          ...
          >
            <div className="absolute inset-0 bg-charcoal-950/60 backdrop-blur-sm" />
          </motion.div>
        )}
      </AnimatePresence>
        ...
        {isMobileOpen && (
          ...
          >
            ...
            <div className="px-4 py-6 border-t border-white/10 space-y-3">
              <a
                href="tel:7172083600"
                className="flex items-center gap-3 px-4 py-3 rounded-lg bg-charcoal-800 hover:bg-charcoal-700 transition-colors text-white"
              >
