...
export default function TrailerDepartment() {
  return (
    <section id="trailer-department" className="py-24 bg-charcoal-900" aria-label="Trailer department">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                {brands.map(({ name, type }) => (
                  <div
                    key={name}
                    className="p-3 rounded-lg bg-charcoal-900/60 border border-charcoal-700 hover:border-brand/40 transition-colors group"
                  >
