...
export default function Industries() {
  return (
    <section id="industries" className="py-24 bg-navy-800" aria-label="Industries we serve">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {industries.map(({ icon: Icon, label }) => (
            ...
            >
              <div className="w-11 h-11 rounded-lg bg-navy-800 group-hover:bg-orange-500/20 flex items-center justify-center transition-all duration-300 border border-navy-700 group-hover:border-orange-500/40">
