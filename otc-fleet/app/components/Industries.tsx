...
export default function Industries() {
  return (
    <section id="industries" className="py-24 bg-charcoal-800" aria-label="Industries we serve">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {industries.map(({ icon: Icon, label }) => (
            ...
            >
              <div className="w-11 h-11 rounded-lg bg-charcoal-800 group-hover:bg-brand/20 flex items-center justify-center transition-all duration-300 border border-charcoal-700 group-hover:border-brand/40">
