...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Background Layers */}
      <div className="absolute inset-0 bg-gradient-to-br from-charcoal-950 via-charcoal-900 to-steel" />
      ...
      <div className="absolute top-0 left-0 w-[400px] h-[400px] rounded-full bg-charcoal-600/20 blur-[100px] pointer-events-none" />
              ...
              <div className="glass rounded-2xl p-6 border border-white/10 shadow-[0_40px_80px_rgba(0,0,0,0.6)]">
                ...
                <div className="grid grid-cols-3 gap-3 mb-5">
                  {floatingCardServices.map(({ icon, label }) => (
                    <div
                      key={label}
                      className="bg-charcoal-800/80 rounded-lg p-3 text-center hover:bg-charcoal-700/80 transition-colors group"
                    >
