...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center overflow-hidden bg-navy-800"
      aria-label="Hero section"
    >
      {/* Background Layers */}
      <div className="absolute inset-0 bg-gradient-to-br from-navy-900 via-navy-900 to-steel" />
      ...
      <div
        ...
        style={{
          backgroundImage:
            'repeating-linear-gradient(45deg, rgba(249,115,22,0.05) 0, rgba(249,115,22,0.05) 1px, transparent 0, transparent 50%)',
          backgroundSize: '24px 24px',
        }}
      />

      {/* Radial glow bottom right */}
      <div className="absolute bottom-0 right-0 w-[600px] h-[600px] rounded-full bg-orange-500/5 blur-[120px] pointer-events-none" />
      <div className="absolute top-0 left-0 w-[400px] h-[400px] rounded-full bg-navy-800/20 blur-[100px] pointer-events-none" />
            ...
            >
              ...
              <div className="glass rounded-2xl p-6 border border-white/10 shadow-[0_40px_80px_rgba(0,0,0,0.6)]">
                ...
                <div className="flex items-center justify-between mb-5">
                  <div>
                    <div className="text-xs text-orange-400 font-bold tracking-wider uppercase mb-1">
                ...
                <div className="grid grid-cols-3 gap-3 mb-5">
                  {floatingCardServices.map(({ icon, label }) => (
                    <div
                      key={label}
                      className="bg-navy-800/80 rounded-lg p-3 text-center hover:bg-navy-800/80 transition-colors group"
                    >
                ...
                <div className="flex gap-3">
                  <div className="flex-1 bg-navy-800/50 rounded-lg p-3">
                    <div className="text-orange-400 text-xs font-bold uppercase tracking-wide mb-0.5">Lancaster</div>
                  ...
                  <div className="flex-1 bg-navy-800/50 rounded-lg p-3">
                    <div className="text-orange-400 text-xs font-bold uppercase tracking-wide mb-0.5">Berks County</div>
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 glass-orange rounded-xl px-4 py-2.5 border border-orange-500/30 shadow-lg"
              >
                <div className="text-orange-400 text-xs font-bold uppercase tracking-wide">20+ Years</div>
